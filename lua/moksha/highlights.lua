...
hl.common = {
    ...
    StatusLine = { fg = c.cream, bg = c.bg_medium },
    StatusLineTerm = { fg = c.cream, bg = c.bg_medium },
    StatusLineNC = { fg = c.grey, bg = c.bg_medium },
    StatusLineTermNC = { fg = c.light_grey, bg = c.bg_medium },
    TabLine = { fg = c.light_grey, bg = c.bg_dark },
    TabLineFill = { fg = c.light_grey, bg = c.bg_medium },
...
hl.plugins.mini = {
    ...
    MiniFilesTitle = { fg = c.light_grey },
    MiniFilesTitleFocused = { fg = c.brown },
}
