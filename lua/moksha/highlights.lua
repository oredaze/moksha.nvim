...
hl.common = {
    ...
    FloatShadow = { bg = c.bg_blue },
    FloatShadowThrough = { bg = c.bg_red },
...
hl.langs.markdown = {
    ...
    markdownH4 = { fg = c.brown, fmt = "bold" },
    markdownH5 = { fg = c.brown, fmt = "bold" },
    markdownH6 = { fg = c.brown, fmt = "bold" },
    markdownUrl = { fg = c.grey, fmt = "underline" },
    markdownItalic = { fg = c.moss, fmt = "none" },
    markdownItalicDelimiter = { fg = c.grey },
    markdownBold = { fg = c.brown, fmt = "bold" },
